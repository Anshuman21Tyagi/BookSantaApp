...
export default class BookRequestScreen extends Component{
  ...
  async getBooksFromApi(bookName)
  {
    ...
    {
      var books = await BookSearch.searchbook(bookName,"AIzaSyCsqLIEUrmMGTD7EXyRqkCn-VlU-d2V6K8")
  ...
  renderItem = ({item,i}) => {
    return(
      <TouchableHighlight style={{alignItems:"center",backgroundColor:"black",padding:10,width:"90%"}}
      activeOpacity={0.8} 
      underlayColor = "black"
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    db.collection('requested_books').add({
        ...
        "book_status" : "requested",
         ...
         "image_link" : books.data[0].volumeInfo.smallThumbnail
